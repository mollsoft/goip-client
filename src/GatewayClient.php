...
use MollSoft\GoipClient\Entities\Gateway\IMEICollection;
use MollSoft\GoipClient\Entities\Gateway\Info;
use MollSoft\GoipClient\Entities\Gateway\LineInfo;
use MollSoft\GoipClient\Entities\Gateway\LineSMS;
use MollSoft\GoipClient\Entities\Gateway\LineSMSCollection;
use MollSoft\GoipClient\Entities\Gateway\OnlineInfo;
use MollSoft\GoipClient\Entities\Gateway\OnlineLine;
use MollSoft\GoipClient\Entities\Gateway\SMS;
use MollSoft\GoipClient\Entities\Gateway\USSDStatus;
use MollSoft\GoipClient\Entities\Gateway\USSDStatusCollection;
...
class GatewayClient extends BasicClient
{
    ...
    public function info(): Info
    {
        ...
        foreach ($gsmInfo as $i => $item) {
            ...
            $lines[] = new LineInfo(
                line: intval($item['CH']),
                gsm: ($item['GSM'] ?? null) === 'Y' || ($item['REG'] ?? null) === 'Y',
